...
function getMovies(query) {
    ...
    axios.get(`http://www.omdbapi.com/?apikey=${process.env.OMDB_API_KEY}&type=movie&s=` + query).then(function (res) {
...
function getGIF(query) {
    ...
    axios.get(`http://api.giphy.com/v1/gifs/search?api_key=${process.env.GIPHY_API_KEY}&q=` + searchQuery).then(function (res) {
